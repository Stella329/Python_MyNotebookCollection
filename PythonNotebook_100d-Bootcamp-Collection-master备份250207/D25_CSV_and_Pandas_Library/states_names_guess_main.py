...
while state_guessed < 50:
    ...
    for state in states_list:
        ...
        if user_answer == state:
            ...
            ## list.index() function returns the index of the first occurrence of an item in a list.
            ...
            coor_y_list.pop(state_index) 
            
            ## list.remove(elements) OR list.pop(index)
            ## list.pop() will return a value, not a list!!! -- 获取被移除的state坐标
